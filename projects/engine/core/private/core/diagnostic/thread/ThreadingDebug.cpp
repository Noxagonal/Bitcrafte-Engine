...
bc::Map<bc::SimpleText, uint32_t>				access_tracker_map;
...
)
{
	...
	position_key.Append( bc::SimpleTextView( source_location.GetFile() ) );
	position_key.Append( bc::SimpleTextView( source_location.GetFunction() ) );
