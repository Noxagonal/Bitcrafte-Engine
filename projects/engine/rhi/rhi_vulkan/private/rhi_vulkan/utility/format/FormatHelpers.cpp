...
auto bc::rhi::CreateAspectMaskFromFormat( VkFormat format ) -> VkImageAspectFlagBits
{
	...
	case VK_FORMAT_G8_B8R8_2PLANE_422_UNORM:
		return VkImageAspectFlagBits( VK_IMAGE_ASPECT_MEMORY_PLANE_0_BIT_EXT | VK_IMAGE_ASPECT_MEMORY_PLANE_1_BIT_EXT );

	case VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM:
	case VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM:
	case VK_FORMAT_G8_B8_R8_3PLANE_444_UNORM:
		return VkImageAspectFlagBits( VK_IMAGE_ASPECT_MEMORY_PLANE_0_BIT_EXT | VK_IMAGE_ASPECT_MEMORY_PLANE_1_BIT_EXT | VK_IMAGE_ASPECT_MEMORY_PLANE_2_BIT_EXT );
