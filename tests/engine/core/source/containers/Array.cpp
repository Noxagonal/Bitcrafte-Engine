...
TEST( CoreContainerArray, StructureBasicInit )
{
	...
	using A = qup::Array<Simple>;
	A a;
	A b {};
	A c = {};
	A d = qup::Array<Simple>();
	A e = qup::Array<Simple> {};
...
TEST( CoreContainerArray, MoveableOnlyStructure )
{
	...
	using A = qup::Array<MoveableOnly>;
	A a;
...
public:
	...
	Array_CopyableOnly_Control & operator=( const Array_CopyableOnly_Control & other ) { ++copy_counter; }
	Array_CopyableOnly_Control & operator=( Array_CopyableOnly_Control && other ) { ++move_counter; }
};
...
public:
	...
	Array_CopyableOnly & operator=( const Array_CopyableOnly & other ) { ++copy_counter; }
...
TEST( CoreContainerArray, Array_CopyableOnlyStructure )
{
	...
	using A = qup::Array<Array_CopyableOnly>;
	using B = qup::Array<Array_CopyableOnly_Control>;
	A a;
...
TEST( CoreContainerArray, CtorDtorCounter )
{
	...
	using A = qup::Array<Array_CtorDtorCounted>;
	A a;
